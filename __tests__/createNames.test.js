import {createFileName, createDirectoryName, createResourceName} from '../src/createNames.js';
...
test('createResource', () => {
    expect(createResourceName('/images/prev/9bbd2aae400b961b2858977fb2ffdf3f_w200.png')).toBe('-images-prev-9bbd2aae400b961b2858977fb2ffdf3f-w200.png');
    expect(createResourceName('/pub#lic/avatars/avat*ar_92080.jpg')).toBe('-pub-lic-avatars-avat-ar-92080.jpg');
    expect(createResourceName('/wwwdata/www/skin/pusto.gif')).toBe('-wwwdata-www-skin-pusto.gif');
});
